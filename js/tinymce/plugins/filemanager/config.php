...
$base_url="http://127.0.0.1"; //url base of site if you want only relative url leave empty
$upload_dir = '/cerfav2git/img/files/'; // path from base_url to upload base dir
$current_path = '../../../../img/files/'; // relative path from filemanager folder to upload files folder
