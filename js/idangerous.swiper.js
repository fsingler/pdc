...
var Swiper = function(f, b) {
    ...
    function W() {
        ...
        if (b.onSlideChangeStart)
            if (b.queueStartCallbacks && a.support.transitions) {
                ...
                b.onSlideChangeStart(a);
        b.onSlideChangeEnd && (a.support.transitions ? b.queueEndCallbacks ? a._queueEndCallbacks || (a._queueEndCallbacks =
                !0, a.wrapperTransitionEnd(b.onSlideChangeEnd)) : a.wrapperTransitionEnd(b.onSlideChangeEnd) : b.DOMAnimation || setTimeout(function() {
            b.onSlideChangeEnd(a)
        }, 10))
    }
    function U() {
    ...
    if ((document.querySelectorAll ||
        ...
        a.wrapperTop = 0;
        a.wrapperBottom = 0;
        var J, p, y, E, x, l, s = {mode: "horizontal", touchRatio: 1, speed: 300, freeMode: !1, freeModeFluid: !1, momentumRatio: 1, momentumBounce: !0, momentumBounceRatio: 1, slidesPerView: 1, slidesPerGroup: 1, simulateTouch: !0, followFinger: !0, shortSwipes: !0, moveStartThreshold: !1, autoplay: !1, onlyExternal: !1, createPagination: !0, pagination: !1, paginationElement: "span", paginationClickable: !1, paginationAsRange: !0, resistance: !0, scrollContainer: !1, preventLinks: !0, noSwiping: !1, noSwipingClass: "swiper-no-swiping",
            ...
            if (e !== a.width || f !== a.height || c) {
                ...
                if (a.initialized) {
                    if (a.callPlugins("onInit"), b.onFirstInit)
                        b.onInit(a)
                } else if (a.callPlugins("onFirstInit"), b.onFirstInit)
                    b.onFirstInit(a);
                a.initialized = !0
            }
        };
                ...
                function(c) {
                    if (a.initialized && 0 != a.slides.length) {
                        ...
                        if ("auto" == b.slidesPerView) {
                            ...
                            a.activeIndex = b.visibilityFullFit ? Math.ceil(-c / p) : Math.round(-c /
                                    p);
        ...
        a.createPagination = function(c) {
            ...
            for (var f = 0; f < e; f++)
                d += "<" + b.paginationElement + ' class="' + b.paginationElementClass +
                        '"></' + b.paginationElement + ">";
            ...
            if (b.pagination && !(1 > a.slides.length)) {
                ...
                if (d && (d = a.paginationButtons, 0 != d.length)) {
                    ...
                    if (b.paginationAsRange) {
                        ...
                        b.loop ? d[a.activeLoopIndex].className += " " + b.paginationActiveClass + " " + b.paginationVisibleClass :
        ...
        a.loadSlides = function() {
            ...
            for (var d = b.loader.slides,
                    e = b.loader.loadAllSlides ? d.length : b.slidesPerView * (1 + b.loader.surroundGroups), f = 0; f < e; f++)
...
Swiper.prototype = {plugins: {}, wrapperTransitionEnd: function(f, b) {
        function g() {
            f(h);
